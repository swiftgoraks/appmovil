...
public class EditarPublicacion extends AppCompatActivity implements imgAdapter.OnClick{
    ...
    public void mostrarImg(ArrayList<String> arrayImg )
    {
        ...
        mRecyclerView.setAdapter(mAdapter);
        pgBar.setVisibility(mRecyclerView.INVISIBLE);
    }

    @Override
    public void onItemClick(int position) {
        Toast.makeText(EditarPublicacion.this,"Mantenga presionado si desea eliminar esta imagen.",Toast.LENGTH_SHORT).show();
    }
